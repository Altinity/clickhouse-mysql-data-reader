...
class Config(object):
        ...
        self.config = {
            ...
            'table_builder': {
                ...
                'clickhouse': {
                    ...
                    'dst_primary_key': self.options['dst_primary_key'],
                    'dst_primary_date_field': self.options['dst_primary_date_field'],
            ...
            'reader': {
                'mysql': {
                    ...
                    'fatal_on_exception': self.options.get_bool('src_fatal_on_exception'),
    ...
    def table_sql_builder(self):
        return TableSQLBuilder(
            ...
            dst_primary_key=self.config['table_builder']['clickhouse']['dst_primary_key'],
            dst_primary_date_field=self.config['table_builder']['clickhouse']['dst_primary_date_field'],
    ...
    def reader(self):
        if self.config['reader']['file']['csv_file_path']:
            ...
            return MySQLReader(
                ...
                fatal_on_exception=self.config['reader']['mysql']['fatal_on_exception'],
